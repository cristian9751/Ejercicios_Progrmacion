...
public class main {
    ...
    public static void main(String[] args) {
        ...
        if(persona2.esJubilado()) {
            System.out.println(persona2.getNombre() + "esta jubilado");
        } else {
            System.out.println(persona2.getNombre() + " no esta jubilado");
        }


        System.out.println("La diferencia de edad entre " + persona1 + " y " + persona2 + " es" +
